...
#
# Script generated by Vivado on Wed Apr 15 04:36:34 -0700 2026
# SW Build 3865809 on Sun May  7 15:05:29 MDT 2023
#
# Tool Version Limit: 2023.05 
#
# Filename     : space_invaders_bd.sh
...
#
# Usage        : space_invaders_bd.sh
#                space_invaders_bd.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                space_invaders_bd.sh [-reset_run]
#                space_invaders_bd.sh [-reset_log]
#                space_invaders_bd.sh [-help]
#
...
#                script (type 'space_invaders_bd.sh -help' for more information).
#
...
# script info
echo -e "space_invaders_bd.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./space_invaders_bd.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  vlogan -work xilinx_vip $vlogan_opts -sverilog +incdir+"$ref_dir/../../../../space_invaders_soc.gen/sources_1/bd/space_invaders_bd/ipshared/ec67/hdl" +incdir+"$ref_dir/../../../../space_invaders_soc.gen/sources_1/bd/space_invaders_bd/ipshared/aed8/hdl" +incdir+"../../../../space_invaders_soc.gen/sources_1/bd/space_invaders_bd/ipshared/ec67/hdl" +incdir+"../../../../space_invaders_soc.gen/sources_1/bd/space_invaders_bd/ipshared/aed8/hdl" +incdir+"E:/Xilinx/Vivado/2023.1/data/xilinx_vip/include" \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.space_invaders_bd xil_defaultlib.glbl -o space_invaders_bd_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./space_invaders_bd_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key space_invaders_bd_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc space_invaders_bd_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./space_invaders_bd.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: space_invaders_bd.sh [-help]\n\
Usage: space_invaders_bd.sh [-step]\n\
Usage: space_invaders_bd.sh [-lib_map_path]\n\
Usage: space_invaders_bd.sh [-reset_run]\n\
Usage: space_invaders_bd.sh [-reset_log]\n\
Usage: space_invaders_bd.sh [-keep_index]\n\
Usage: space_invaders_bd.sh [-noclean_files]\n\n\
